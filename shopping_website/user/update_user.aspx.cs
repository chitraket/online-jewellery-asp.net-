...
public partial class user_update_user : System.Web.UI.Page
{
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        cmd1.CommandText = "update registration set firstname='" + t1.Text + "',lastname='" + t2.Text + "',email='"+TextBox3.Text+"',password='"+TextBox4.Text+"',address='" + t3.Text + "',city='" + t4.Text + "',state='" + t5.Text + "',mobile='" + t6.Text + "' where Id='" + id.ToString() + "'";
