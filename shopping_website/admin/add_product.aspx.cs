...
public partial class admin_add_product : System.Web.UI.Page
{
    ...
    protected void b1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = con.CreateCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "insert into product values('" + t1.Text + "','" + t2.Text + "', '" + t3.Text + "','" + t4.Text + "','" + t5.Text + "','" + t6.Text + "','" + t7.Text + "','" + t9.Text + "','" + t10.Text + "','" + t11.Text + "','" + b.ToString() + "','" + dd.SelectedItem.ToString() + "','" + t12.Text + "','" + t13.Text + "','" + t14.Text + "','" + t15.Text + "','" + t16.Text + "')";
        cmd.ExecuteNonQuery();
      // Label1.Text = t2.Text;
