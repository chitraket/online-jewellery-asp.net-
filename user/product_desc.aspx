...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" Runat="Server"> 
   ...
   <div style ="height:367px;width:600px;border-style:solid;border-width:2px;">
    ...
    <br />
    <table>
        <tr><td style="width: 862px"></td></tr>
        <tr><td style="width: 862px"><asp:Label ID="Label30" runat="server" Text="Label"></asp:Label></td></tr>
         <tr> <td style="width: 862px"><asp:TextBox ID="TextBox8" CssClass="field" runat="server" Width="196px"></asp:TextBox>
            ...
            <asp:Button ID="b2" runat="server" Text="check pincode" OnClick="b2_Click" Height="26px" Width="97px" BackColor="DarkRed" BorderColor="DarkRed" ForeColor="White" style="margin:12px 0 10px 0;display:block;cursor:pointer;border:0;" /> </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 862px">
                <asp:Label ID="L3" runat="server" Text="Label" ForeColor="Red"></asp:Label></td>
        </tr>
        <tr>
            <td style="width: 862px" ><asp:Button ID="b1" runat="server" Text="Add to cart" OnClick="b1_Click" Height="26px" Width="97px" BackColor="DarkRed" BorderColor="DarkRed" ForeColor="White" style="margin:12px 0 10px 0;display:block;cursor:pointer;border:0;" />  </td>
   </tr>
        <tr>
            <td style="width: 862px"><asp:Label ID="l1" runat="server" ForeColor="Red"></asp:Label>  </td>
        </tr>
        </table>
