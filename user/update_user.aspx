    ...
    <br />
     <table>
      ...
      <tr>
         ...
         <tr>
         <td style="width: 349px">Pincode</td></tr>
         <tr>
            <td style="width: 349px"><asp:TextBox ID="TextBox4" runat="server" CssClass="field" Width="244px" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBox4" ErrorMessage="Enter pincode" ForeColor="#CC0000"></asp:RequiredFieldValidator>
            </td>
        </tr>
         <tr>
            <td style="width: 349px">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="TextBox4" ErrorMessage="Invalid Pincode" ForeColor="#CC0000" ValidationExpression="[0-9]{6}"></asp:RegularExpressionValidator>
                </td>
            <td>
                &nbsp;</td>
        </tr>
