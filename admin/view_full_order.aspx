...
<asp:Content ID="Content1" ContentPlaceHolderID="c1" Runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label><br />
      <asp:Button ID="Button2" runat="server" Text="Packed" OnClick="Button2_Click" BackColor="#214761" BorderColor="#214761" BorderStyle="None" ForeColor="White" Height="39px" Width="148px" />
      <asp:Button ID="Button1" runat="server" Text="Shipped" OnClick="Button1_Click" BackColor="#214761" BorderColor="#214761" BorderStyle="None" ForeColor="White" Height="39px" Width="148px" />
     <asp:Button ID="b1" runat="server" Text="delivery product" OnClick="b1_Click" BackColor="#214761" BorderColor="#214761" BorderStyle="None" ForeColor="White" Height="39px" Width="148px" />
</asp:Content>
